...
{
loadDoc("q="+str,"proc3.php",function()
  {
...
{
loadDoc("r="+str,"proc5.php",function()
  {
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
...
function Valida ()
{
	if(document.frmcarpeta.txtnombre.value==''){
		alert('Debe ingresar el nombre de la carpeta');
		document.frmcarpeta.txtnombre.focus();
		return false;
	}
	if(document.frmcarpeta.lstoficina.value==''){
		alert('Debe seleccionar la oficina donde se alojará el documento');
		document.frmcarpeta.lstoficina.focus();
		return false;
	}
	if(document.frmcarpeta.lstlugar.value==''){
		alert('Debe seleccionar el lugar donde se alojará la carpeta');
...
?>				
                ...
                <form action="carpeta2.php" method="post" name="frmcarpeta" onsubmit="return Valida()">
				<table class="content">
                <tr>
                <td width="40%">
                	<table>      
...
?>
											<SELECT NAME="lstoficina" onchange="myFunction(this.value)">
											<option></option>
<?php
